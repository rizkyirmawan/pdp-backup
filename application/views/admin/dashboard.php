      ...
      <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah Crew</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php if (!empty($kru)) {
                                                                          echo count($kru).' Orang';
                                                                        } else {
                                                                          echo '<i>Tidak Ada</i>';
                                                                        } 
                                                                  ?>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Jumlah Client</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php if (!empty($client)) {
                                                                          echo count($client).' Client';
                                                                        } else {
                                                                          echo '<i>Tidak Ada</i>';
                                                                        } 
                                                                  ?></div>
            ...
            <div class="col-auto">
              <i class="fab fa-strava fa-2x text-gray-300"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Jumlah Project</div>
    ...
    <div class="row mb-4">
      ...
      <div class="col-lg-6">
        ...
        <div class="card bg-primary text-white shadow">
          <div class="card-header bg-primary py-3 d-flex flex-row align-items-center justify-content-between rounded-sm">
            <h6 class="m-0 font-weight-bold text-white">Data Crew</h6>
            <div class="dropdown no-arrow">
              <a href="<?php echo base_url('admin/kru') ?>" class="btn btn-primary bg-gradient-primary btn-icon-split btn-sm">
      ...
      <div class="col-lg-6">
        ...
        <div class="card bg-success text-white shadow">
          <div class="card-header bg-success py-3 d-flex flex-row align-items-center justify-content-between rounded-sm">
            ...
            <div class="dropdown no-arrow">
              <a href="<?php echo base_url('admin/client') ?>" class="btn btn-success bg-gradient-success btn-icon-split btn-sm">
                <span class="icon text-white-50">
                  <i class="fas fa-angle-right"></i>
                </span>
                <span class="text">Tinjau</span>
      ...
      <div class="col-lg-6">
       ...
       <div class="card bg-info text-white shadow">
          <div class="card-header bg-info py-3 d-flex flex-row align-items-center justify-content-between rounded-sm">
            ...
            <div class="dropdown no-arrow">
              <a href="<?php echo base_url('admin/project') ?>" class="btn btn-info bg-gradient-info btn-icon-split btn-sm">
                <span class="icon text-white-50">
                  <i class="fas fa-angle-right"></i>
                </span>
                <span class="text">Tinjau</span>
